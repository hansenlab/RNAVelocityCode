...
sceasy::convertFormat(here::here('data/ForebrainGlut/hgForebrainGlut.loom'), from="loom", to="sce",
											outFile=here::here('data/forebrain/forebrain.rds'))

sce.o <-  as(readRDS(here::here('data/forebrain/forebrain.rds')), "SingleCellExperiment")
...
qsave(sce.o, file = here::here("data/forebrain/sce.o.qs"))
qsave(steady.o, file = here::here("data/forebrain/steady.o.qs"))
qsave(dynamical.o, file = here::here("data/forebrain/dynamical.o.qs"))
qsave(umap.o, file = here::here("data/forebrain/umap.o.qs"))
