...
steady_vec.p <-
	plotEmbExp(
		...
		title = "Steady trans.pro (learned k-NN)",
		x_lab = "PCA-1",
		y_lab = "PCA-2",
		color.name = "time",
		point.size = 5.01,
...
steady_proj.p <-
	plotEmbExp(
		...
		"X_pca",
		color.v = steady.o$true_t,
		title = "Steady proj. (learned k-NN)",
		x_lab = "PCA-1",
		y_lab = "PCA-2",
		color.name = "time",
		point.size = 5.01,
...
dynamical_vec.p <-
	plotEmbExp_nopoint(
		...
		title = "Dynamical trans.pro (learned k-NN)",
		x_lab = "PCA-1",
		y_lab = "PCA-2",
		color.name = "time",
		point.size = 5.01,
...
aux.p <-
	plotEmbExp(
		...
		"X_pca",
		color.v = dynamical.o$true_t,
		title = "Simulation with noise level 5",
		x_lab = "PCA-1",
		y_lab = "PCA-2",
		color.name = "time",
		point.size = 5.01,
...
dynamical_proj.p <-
	plotEmbExp_nopoint(
		...
		"X_pca",
		color.v = dynamical.o$true_t,
		title = "Dynamical proj. (learned k-NN)",
		x_lab = "PCA-1",
		y_lab = "PCA-2",
		color.name = "time",
		point.size = 5.01,
...
true_vec.p <-
	plotEmbExp_nopoint(
		...
		title = "True v. trans.pro (learned k-NN)",
		x_lab = "PCA-1",
		y_lab = "PCA-2",
		color.name = "time",
		point.size = 5.01,
...
true_proj.p <-
	plotEmbExp_nopoint(
		...
		"X_pca",
		color.v = sce.o$true_t,
		title = "True v. projection (learned k-NN)",
		x_lab = "PCA-1",
		y_lab = "PCA-2",
		color.name = "t",
		point.size = 5.01,
...
grid.df <-
	gridVectors(reducedDim(steady.o, "X_pca")[idx, ], embedded[idx, ], resolution = 20)
steady_vec_trueknn.p <-
	plotEmbExp(
		steady.o,
		"X_pca",
		color.v = steady.o$true_t,
		title = "Steady trans.pro (true k-NN)",
		x_lab = "PCA-1",
		y_lab = "PCA-2",
		color.name = "time",
		point.size = 5.01,
...
grid.df <-
	gridVectors(reducedDim(steady.o, "X_pca")[idx, ], embedded[idx, ], resolution = 20)
steady_proj_trueknn.p <-
	plotEmbExp(
		steady.o,
		"X_pca",
		color.v = steady.o$true_t,
		title = "Steady proj. (true k-NN)",
		x_lab = "PCA-1",
		y_lab = "PCA-2",
		color.name = "time",
		point.size = 5.01,
...
grid.df <-
	gridVectors(reducedDim(dynamical.o, "X_pca")[idx, ], embedded[idx, ], resolution = 20)
dynamical_vec_trueknn.p <-
	plotEmbExp_nopoint(
		dynamical.o,
		"X_pca",
		color.v = dynamical.o$true_t,
		title = "Dynamical trans.pro (true k-NN)",
		x_lab = "PCA-1",
		y_lab = "PCA-2",
		color.name = "time",
		point.size = 5.01,
...
grid.df <-
	gridVectors(reducedDim(dynamical.o, "X_pca")[idx, ], embedded[idx, ], resolution = 20)
dynamical_proj_trueknn.p <-
	plotEmbExp_nopoint(
		dynamical.o,
		"X_pca",
		color.v = dynamical.o$true_t,
		title = "Dynamical proj. (true k-NN)",
		x_lab = "PCA-1",
		y_lab = "PCA-2",
		color.name = "time",
		point.size = 5.01,
...
true_vec_trueknn.p <-
	plotEmbExp_nopoint(
		...
		"X_pca",
		color.v = sce.o$true_t,
		title = "True v. trans.pro (true k-NN)",
		x_lab = "PCA-1",
		y_lab = "PCA-2",
		color.name = "time",
		point.size = 5.01,
...
true_proj_trueknn.p <-
	plotEmbExp_nopoint(
		...
		"X_pca",
		color.v = sce.o$true_t,
		title = "True v. projection (true k-NN)",
		x_lab = "PCA-1",
		y_lab = "PCA-2",
		color.name = "t",
		point.size = 5.01,
...
cos_violin.p <-
	...
	labs(y = "Cosine similarity", title = "Cosine similarity to the \ntrue vector fields in (b)") +
	theme(
...
pbmc68k.p <-
	...
	scale_color_manual(
		values = brewer.pal(nlevels(factor(pbmc68k.o$celltype)), "Set3"),
		name = "Cell type",
		labels = levels(factor(pbmc68k.o$celltype)),
		limits = levels(factor(pbmc68k.o$celltype))
	) +
	guides(color = guide_legend(ncol = 1)) +
	labs(y = "TSNE-2", x = "TSNE-1") +
	ggtitle(str_c("PBMC68k")) +
	.theme_noframe +
	theme(
...
col2.p <-
	plot_grid(
		true_proj_trueknn.p + ggtitle(TeX(r'(True $\textbf{V}$ projection)')),
		dynamical_proj.p,
		dynamical_proj_trueknn.p,
		nrow = 3,
		ncol = 1,
...
col3.p <-
	plot_grid(
		cos_violin.p,
		pbmc68k.p + theme(legend.position = "none"),
		get_legend(pbmc68k.p),
		nrow = 3,
		ncol = 1,
		label_size = 10,
		labels = c("g", "h", "")
...
save_plot(
	here::here("figs", "main", "main.noise_emb.pdf"),
	mp,
