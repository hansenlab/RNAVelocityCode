...
qsave(sce.o, file = here::here("data/erythroid/sce.o.qs"))
qsave(dynamical.o, file = here::here("data/erythroid/dynamical.o.qs"))
qsave(steady.o, file = here::here("data/erythroid/steady.o.qs"))
