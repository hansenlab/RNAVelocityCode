...
reducedDimNames(sce.o) <- c("PCA", "UMAP")
...
qsave(sce.o, file = here::here("data/gastrulation_e75/sce.o.qs"))
qsave(steady.o, file = here::here("data/gastrulation_e75/steady.o.qs"))
qsave(dynamical.o, file = here::here("data/gastrulation_e75/dynamical.o.qs"))
# qsave(umap.o, file = here::here("data/gastrulation_e75/umap.o.qs"))
