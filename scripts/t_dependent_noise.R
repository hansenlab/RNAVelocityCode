...
adata <- scv$datasets$simulation(n_obs=500L, n_vars=10L, t_max=25, alpha=5, beta=.3, gamma=.5, noise_level=10)
scv$pp$pca(adata)
...
adata2 <- scv$datasets$simulation(n_obs=n_obs, n_vars=10L, t_max=25, alpha=alpha, beta=.3, gamma=gamma, noise_level=10)
...
adata3 <- scv$datasets$simulation(n_obs=n_obs, n_vars=10L, t_max=25, alpha=alpha, beta=.3, gamma=gamma, noise_level=10)
scv$pp$pca(adata3)
...
save_plot(here::here("figs", "t_dependent", "t_dependent_noise.pdf"), mp,
