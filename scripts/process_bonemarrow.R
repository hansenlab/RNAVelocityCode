...
qsave(sce.o, file = here::here("data/bonemarrow/sce.o.qs"))
qsave(steady.o, file = here::here("data/bonemarrow/steady.o.qs"))
qsave(dynamical.o, file = here::here("data/bonemarrow/dynamical.o.qs"))
qsave(umap.o, file = here::here("data/bonemarrow/umap.o.qs"))
