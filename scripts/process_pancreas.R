...
qsave(sce.o, file = here::here("data/Pancreas/sce.o.qs"))
qsave(steady.o, file = here::here("data/Pancreas/steady.o.qs"))
qsave(dynamical.o, file = here::here("data/Pancreas/dynamical.o.qs"))
qsave(umap.o, file = here::here("data/Pancreas/umap.o.qs"))
