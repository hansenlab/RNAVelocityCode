...
p8 <- plotxy(assay(sce3.o, "spliced")[6, ], assay(sce3.o, "unspliced")[6, ], title = "\u03B1 = 5, time-dep. \u03B3", x_lab = "Spliced",
						 y_lab = "Unspliced", color_by = "true_t", point.size = 5.01,
						 colors.v = sce.o$true_t,
						 hue.colors = c("#440154", "#482576", "#414487","#35608D",
						 							 "#2A788E", "#21908C","#22A884", "#43BF71",
...
p9 <- plotxy2(x = de3.v, assay(sce3.o, "velocity")[, 50], title = "\u03B1 = 5 or 30, time-dep. \u03B3", x_lab = "Difference of Ms between two cells",
							y_lab = "Estimated velocity", point.size = 8.01, color_var = factor(c(1, 1, 0, 2, 2, 1, rep(0, 2), 2, 0)),
							colors.v = c("black",  "#377EB8", "#FF7F00"), labels = c(0, 1, 2)) +
...
save_plot(here::here("figs", "t_dependent", "t_dependent2.pdf"), mp,
