...
save_plot(here::here("figs", "pancreas", str_c("vec.pdf")), vec.p,
...
top30.lp <- lapply(seq_len(30), function(i) {
	...
	p <- plot_dynamicalmums2(sce.o, rownm = g, color_by = "clusters", colors.v = metadata(sce.o)$clusters_colors, point.size = 2.01,
...
save_plot(here::here("figs", "pancreas", str_c("top30.pdf")), mp,
