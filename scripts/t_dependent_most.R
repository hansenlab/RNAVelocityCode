...
adata2 <- scv$datasets$simulation(n_obs=n_obs, n_vars=10L, t_max=25, alpha=5, beta=.3, gamma=gamma, noise_level=0.8)
...
save_plot(here::here("figs", "t_dependent", "t_dependent_most.pdf"), mp,
